...
export const BackgroundBeams = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      <div className="absolute inset-[-40%] animate-[spin_18s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,rgba(120,119,198,0.25),rgba(59,130,246,0.05),rgba(236,72,153,0.15),rgba(120,119,198,0.25))] blur-3xl opacity-50" />
    </div>
  );
};
